...
def get_key_id(params):
	...
	if search_type == 'media_title':
		if media_type == 'movie': url_params, string = {'mode': 'orac.search', 'action': 'tmdb_movies_search', 'media_type': 'movie'}, 'movie_queries'
		elif media_type == 'tv_show': url_params, string = {'mode': 'orac.search', 'action': 'tmdb_tv_search', 'media_type': 'tv_show'}, 'tvshow_queries'
