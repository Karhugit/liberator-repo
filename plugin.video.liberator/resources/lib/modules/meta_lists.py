...
status_tvshows = [
{'name': 'Returning Series', 'id': 0}, {'name': 'Ended', 'id': 1}, {'name': 'In Production', 'id': 2},
{'name': 'Planned', 'id': 3}, {'name': 'Pilot', 'id': 4}, {'name': 'Canceled', 'id': 5}
]
...
ui_languages = sorted([
    ...
    {'name': 'Arabic', 'id': 'ar-SA'},
    {'name': 'Russian', 'id': 'ru-RU'},
    {'name': 'Hindi', 'id': 'hi-IN'},
    {'name': 'Dutch', 'id': 'nl-NL'},
    {'name': 'Polish', 'id': 'pl-PL'},
    {'name': 'Swedish', 'id': 'sv-SE'},
    {'name': 'Danish', 'id': 'da-DK'},
    {'name': 'Norwegian', 'id': 'no-NO'},
    {'name': 'Finnish', 'id': 'fi-FI'},
    {'name': 'Turkish', 'id': 'tr-TR'},
    {'name': 'Thai', 'id': 'th-TH'},
    {'name': 'Vietnamese', 'id': 'vi-VN'},
    {'name': 'Indonesian', 'id': 'id-ID'},
    {'name': 'Hebrew', 'id': 'he-IL'},
    {'name': 'Czech', 'id': 'cs-CZ'},
    {'name': 'Hungarian', 'id': 'hu-HU'},
    {'name': 'Romanian', 'id': 'ro-RO'},
    {'name': 'Ukrainian', 'id': 'uk-UA'},
    {'name': 'Greek', 'id': 'el-GR'},
    {'name': 'Bulgarian', 'id': 'bg-BG'},
], key=lambda x: x['name'])
...
{'id': 'CZ', 'name': 'Czech Republic'},     {'id': 'DK', 'name': 'Denmark'},          {'id': 'EG', 'name': 'Egypt'},
{'id': 'FI', 'name': 'Finland'},            {'id': 'FR', 'name': 'France'},           {'id': 'DE', 'name': 'Germany'},
...
networks = [
{'id': 2, 'name': 'ABC', 'icon': 'network_abc'},						{'id': 3, 'name': 'BBC 3', 'icon': 'network_bbc3'},
{'id': 4, 'name': 'BBC 1', 'icon': 'network_bbc1'},						{'id': 6, 'name': 'NBC', 'icon': 'network_nbc'},                                                 
{'id': 9, 'name': 'ITV', 'icon': 'network_itv'}, 						{'id': 10, 'name': 'Discovery Health', 'icon': 'network_discoveryhealth'},	
{'id': 13, 'name': 'Nickelodeon', 'icon': 'network_nickelodeon'}, 		{'id': 14, 'name': 'PBS', 'icon': 'network_pbs'},
{'id': 15, 'name': 'CBBC', 'icon': 'network_cbbc'},						{'id': 16, 'name': 'CBS', 'icon': 'network_cbs'},
{'id': 17, 'name': 'MTV2', 'icon': 'network_mtv2'},						{'id': 18, 'name': 'ABC TV', 'icon': 'network_abctv'},
{'id': 19, 'name': 'FOX', 'icon': 'network_fox'},						{'id': 21, 'name': 'The WB', 'icon': 'network_thewb'},
{'id': 22, 'name': 'Discovery kids', 'icon': 'network_discoverykids'},	{'id': 23, 'name': 'CBC', 'icon': 'network_cbc'},
{'id': 24, 'name': 'BET', 'icon': 'network_bet'},						{'id': 26, 'name': 'Channel 4', 'icon': 'network_channel4'}, 			
{'id': 29, 'name': 'ESPN', 'icon': 'network_espn'}, 					{'id': 30, 'name': 'USA Network', 'icon': 'network_usanetwork'},
{'id': 33, 'name': 'MTV', 'icon': 'network_mtv'},						{'id': 34, 'name': 'Lifetime', 'icon': 'network_lifetime'},
{'id': 35, 'name': 'Nick Junior', 'icon': 'network_nickjr'}, 			{'id': 37, 'name': 'MSNBC', 'icon': 'network_msnbscc'},
{'id': 41, 'name': 'TNT', 'icon': 'network_tnt'},						{'id': 43, 'name': 'National Geographic', 'icon': 'network_natgeo'}, 
{'id': 44, 'name': 'Disney XD', 'icon': 'network_disneyxd'},			{'id': 47, 'name': 'Comedy Central', 'icon': 'network_comedycentral'},
{'id': 49, 'name': 'HBO', 'icon': 'network_hbo'},						{'id': 51, 'name': 'The Comedy Network', 'icon': 'network_thecomedynetwork'},
{'id': 54, 'name': 'Disney Channel', 'icon': 'network_disney'},			{'id': 55, 'name': 'Spike', 'icon': 'network_spike'},
{'id': 56, 'name': 'Cartoon Network', 'icon': 'network_cartoonnetwork'},{'id': 64, 'name': 'Discovery Channel', 'icon': 'network_discovery'}, 
{'id': 65, 'name': 'History Channel', 'icon': 'network_history'},		{'id': 66, 'name': 'Nine Network', 'icon': 'network_ninenetwork'},
{'id': 67, 'name': 'Showtime', 'icon': 'network_showtime'}, 			{'id': 68, 'name': 'TBS', 'icon': 'network_tbs'},
{'id': 71, 'name': 'The CW', 'icon': 'network_thecw'},					{'id': 74, 'name': 'Bravo', 'icon': 'network_bravo'},
{'id': 75, 'name': 'ABC Family', 'icon': 'network_abcfamily'},			{'id': 76, 'name': 'E!', 'icon': 'network_e'},
{'id': 77, 'name': 'Syfy', 'icon': 'network_syfy'},						{'id': 80, 'name': 'Adult Swim', 'icon': 'network_adultswim'},
{'id': 84, 'name': 'TLC', 'icon': 'network_tlc'},						{'id': 88, 'name': 'FX', 'icon': 'network_fx'},
{'id': 91, 'name': 'Animal Planet', 'icon': 'network_animalplanet'}, 	{'id': 99, 'name': 'Channel 5', 'icon': 'network_channel5'},
{'id': 100, 'name': 'BBC 4', 'icon': 'network_bbc4'},					{'id': 102, 'name': 'The Comedy Channel', 'icon': 'network_thecomedychannel'},
{'id': 106, 'name': 'Discovery', 'icon': 'network_discovery'},			{'id': 110, 'name': 'CTV', 'icon': 'network_ctv'},
{'id': 113, 'name': 'Fuse', 'icon': 'network_fuse'},					{'id': 115, 'name': 'Sky Living', 'icon': 'network_skyliving'},
{'id': 126, 'name': 'BBC Choice', 'icon': 'network_bbcchoice'},			{'id': 127, 'name': 'LWT', 'icon': 'network_lwt'},
{'id': 129, 'name': 'A&E', 'icon': 'network_ane'},						{'id': 132, 'name': 'Oxygen', 'icon': 'network_oxygen'},
{'id': 136, 'name': 'E4', 'icon': 'network_e4'},						{'id': 149, 'name': 'ITV2', 'icon': 'network_itv2'},
{'id': 158, 'name': 'VH1', 'icon': 'network_vh1'},						{'id': 174, 'name': 'AMC', 'icon': 'network_amc'},
{'id': 202, 'name': 'WGN America', 'icon': 'network_wgnamerica'}, 		{'id': 209, 'name': 'Travel Channel', 'icon': 'network_travel'},
{'id': 210, 'name': 'HGTV', 'icon': 'network_hgtv'},					{'id': 211, 'name': 'Prime Time', 'icon': 'network_primetime'}, 
{'id': 213, 'name': 'Netflix', 'icon': 'network_netflix'},				{'id': 214, 'name': 'Sky 1', 'icon': 'network_sky1'}, 
{'id': 217, 'name': 'Cartoon Network', 'icon': 'network_cartoonnetwork'},{'id': 224, 'name': 'Nicktoons', 'icon': 'network_nicktoons'}, 
{'id': 243, 'name': 'Fox Reality', 'icon': 'network_foxreality'}, 		{'id': 244, 'name': 'Investigation Discovery', 'icon': 'network_investigationdiscovery'},
{'id': 245, 'name': 'The Movie Network', 'icon': 'network_themovienetwork'},{'id': 247, 'name': 'YouTube', 'icon': 'network_youtube'},
{'id': 251, 'name': 'Audience', 'icon': 'network_audience'},			{'id': 261, 'name': 'ITV4', 'icon': 'network_itv4'},
{'id': 265, 'name': 'Soho', 'icon': 'network_soho'},					{'id': 281, 'name': 'Disney Jr', 'icon': 'network_disneyjr'},
{'id': 286, 'name': 'Nickelodeon', 'icon': 'network_nickelodeon'},		{'id': 298, 'name': 'More4', 'icon': 'network_more4'},
{'id': 303, 'name': 'Fox', 'icon': 'network_fox'},						{'id': 312, 'name': 'Bravo', 'icon': 'network_bravo'},
{'id': 318, 'name': 'Starz', 'icon': 'network_starz'},					{'id': 332, 'name': 'BBC 2', 'icon': 'network_bbc2'},
{'id': 359, 'name': 'Cinemax', 'icon': 'network_cinemax'},				{'id': 364, 'name': 'truTV', 'icon': 'network_trutv'},
{'id': 382, 'name': 'UK Gold', 'icon': 'network_ukgold'},				{'id': 384, 'name': 'Hallmark Channel', 'icon': 'network_hallmark'}, 
{'id': 388, 'name': 'UK Dave', 'icon': 'network_ukdave'},				{'id': 397, 'name': 'TV Land', 'icon': 'network_tvland'},
{'id': 405, 'name': 'Sky 2', 'icon': 'network_sky2'},					{'id': 453, 'name': 'Hulu', 'icon': 'network_hulu'},
{'id': 1431, 'name': 'Sky One', 'icon': 'network_skyone'},				{'id': 1755, 'name': 'Sky History', 'icon': 'network_skyhistory'}, 
{'id': 4148, 'name': 'Sky Documentaries', 'icon': 'network_skydocumentaries'}   
	]
...
discover_items = {
'with_year_start': {'label': 'Start Date', 'key': 'with_year_start', 'display_key': 'with_year_start_display', 'action': 'start_date',
'url_insert_movie': '&primary_release_date.gte=%s', 'url_insert_tvshow': '&first_air_date.gte=%s', 'name_value': ' | from %s', 'icon': 'calender'},
...
'add_to_library': {'label': 'Add to Library', 'key': 'add_to_library', 'display_key': 'add_to_library_display', 'action': 'add_to_library',
'url_insert': '&add_to_library=%s', 'name_value': ' | Add to Library', 'icon': 'lists'}
		}
