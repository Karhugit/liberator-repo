...
from modules.watched_status import get_database, watched_info_season, get_watched_status_season
		...
		for item in season_data:
			try:
				...
				set_properties({'totalepisodes': string(aired_eps), 'watchedprogress': string(visible_progress),
								'liberator.extras_params': extras_params, 'liberator.options_params': options_params})
				if is_external:
...
def single_seasons(seasons_list):
	...
	make_thread_list(_process, seasons_list)
