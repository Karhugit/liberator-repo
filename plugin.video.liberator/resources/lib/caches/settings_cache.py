...
class SettingsCache:
	def get(self, setting_id):
		try:
			...
			setting_id = setting_id.replace('liberator.', '')
	...
	def set_memory_cache(self, setting_id, setting_value):
		set_property('liberator.%s' % setting_id, setting_value)

	def delete_memory_cache(self, setting_id):
		clear_property('liberator.%s' % setting_id)
...
def set_path(params):
	...
	new_value = kodi_dialog().browse(browse_mode, '', '', defaultt=get_setting('liberator.%s' % setting_id))
	set_setting(setting_id, new_value)
...
def set_source_folder_path(params):
	setting_id = params['setting_id']
	current_setting = get_setting('liberator.%s' % setting_id)
...
#==================== Downloads
{'setting_id': 'movie_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.liberator/Movies Downloads/', 'browse_mode': '0'},
{'setting_id': 'tvshow_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.liberator/TV Show Downloads/', 'browse_mode': '0'},
{'setting_id': 'premium_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.liberator/Premium Downloads/', 'browse_mode': '0'},
{'setting_id': 'image_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.liberator/Image Downloads/', 'browse_mode': '0'},
...
{'setting_id': 'tmdb.user', 'setting_type': 'string', 'setting_default': 'empty_setting'},
...
{'setting_id': 'simkl.expires', 'setting_type': 'string', 'setting_default': '0'},
